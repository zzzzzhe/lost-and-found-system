...
public interface PostDao {
    ...
    @Insert("insert into post(uname,type_name,title,content,picture,address,ctime,status,flag,view_count) values" +
            "(#{uname},#{typeName},#{title},#{content},#{picture},#{address},#{ctime},#{status},#{flag},0)")
